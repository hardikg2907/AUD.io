    ...
    return (
        <div className='w-full h-[87%] custom-scrollbar overflow-auto rounded-3xl bg-[#181717] mt-5 text-white'>
            <div
                ...
                style={{ background: 'linear-gradient(to bottom, #434343 0%, #181717 100%)' }}
            >
                <img src='https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png' className='w-32 h-32 rounded-full' />
            ...
            <div className='px-10 py-5 flex flex-col gap-8'>
                ...
                <div className=''>
                    <p className='text-xl border-b-[1px] border-[#646060] pb-3 font-bold'>Security Settings</p>
                    <form className='flex flex-col justify-start items-start gap-5 p-3'>
                        ...
                        <button className='p-2 bg-[#f03a47] rounded-md hover:bg-[#6a2b2f] transition-all duration-300 ease-in-out'>Reset Password</button>
                    </form>
                </div>
            </div>
        </div>
